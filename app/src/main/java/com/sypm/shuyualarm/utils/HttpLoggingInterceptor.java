...
public class HttpLoggingInterceptor implements Interceptor {
        ...
        if (logHeaders) {
            ...
            if (!logBody || !HttpEngine.hasBody(response)) {
                ...
                if (contentLength != 0) {
                    ...
                    logger.log(FormatUtil.formatJson(FormatUtil.decodeUnicode(bufferString)));
                }
     ...
     * of code my_points to detect unicode control characters commonly used in binary file signatures.
     */
